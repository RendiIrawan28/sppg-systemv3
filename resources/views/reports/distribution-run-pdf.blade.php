...
<body>
    ...
    <table class="no-border">
        ...
        <tr><td>Kembali</td><td>: {{ $run->returned_small_portions }} kecil + {{ $run->returned_large_portions }} besar</td><td>Belum Terjelaskan</td><td>: {{ $run->unaccounted_total }}</td></tr>
    </table>
    ...
    <table>
        <thead>
            <tr>
                <th>No</th><th>Tujuan</th><th>Rencana</th><th>Tiba</th><th>Dibawa K/B</th><th>Terkirim K/B</th><th>Kembali K/B</th><th>Penerima</th><th>Status</th><th>Ompreng K/R/H</th>
            </tr>
        </thead>
        <tbody>
        @forelse($run->stops as $stop)
            <tr>
                ...
                <td>{{ $stop->containers_returned }}/{{ $stop->containers_damaged }}/{{ $stop->containers_lost }}</td>
            </tr>
        @empty
