        ...
        @if (auth()->user()->is_super_admin || auth()->user()->can('monitoring_operasional.view'))
            ...
            >
                <div class="flex items-start gap-4">
                    <span class="grid size-12 shrink-0 place-items-center rounded-2xl bg-[#081d3a] text-white shadow-lg shadow-slate-900/10">
                        <x-v3.icon name="clipboard" class="size-6" />
                    </span>
                    <div>
