<x-v3.shell :$unit :$navigation :$roleLabel :title="$definition['label']" eyebrow="Operasional harian native V3">
    <div class="mx-auto max-w-[1450px] space-y-5">
        ...
        <div class="flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
            ...
            @if ($canCreate)<a wire:navigate href="{{ route('v3.operations.create', ['module' => $module]) }}" class="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-sky-600 px-5 text-sm font-bold text-white shadow-lg shadow-sky-600/20"><x-v3.icon name="plus" class="size-4" /> Tambah {{ $definition['label'] }}</a>@endif
        </div>
