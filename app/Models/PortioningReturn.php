...
class PortioningReturn extends Model
{
    ...
    protected $fillable = [
        'sppg_unit_id', 'portioning_session_id', 'portioning_supply_id',
        ...
        'requested_quantity', 'actual_quantity', 'condition_status',
        'warehouse_disposition', 'reason', 'photo_path', 'warehouse_notes', 'status',
        'returned_by', 'submitted_at', 'verified_by', 'verified_at', 'rejected_at',
    ];
    ...
    {
        return $this->belongsTo(PortioningSupply::class, 'portioning_supply_id');
    }
