...
class WashingSession extends Model
{
    ...
    protected $fillable = [
        ...
        'waste_handover_notes', 'waste_handover_report_id',
    ...
    public function wasteHandoverReport(): BelongsTo { return $this->belongsTo(WasteHandoverReport::class, 'waste_handover_report_id'); }
