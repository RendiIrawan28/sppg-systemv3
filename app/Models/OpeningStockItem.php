...
{
    protected $fillable = ['opening_stock_id', 'ingredient_id', 'inventory_lot_id', 'ingredient_name_snapshot', 'unit_snapshot', 'quantity', 'lot_number', 'expired_date', 'storage_type', 'location_name', 'condition_notes'];
