    ...
    public function for(User $user, SppgUnit $unit): array
    {
        $groups = [
            ...
            $this->module('administrasi', 'Administrasi Sistem', 'settings', [
                ...
                $this->item('Reset data modul', 'trash', route('v3.administration.module-data-reset'), request()->routeIs('v3.administration.module-data-reset'), (bool) $user->is_super_admin),
