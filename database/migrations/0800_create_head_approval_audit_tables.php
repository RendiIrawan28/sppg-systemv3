...
return new class extends Migration
{
    ...
    public function up(): void
    {
        $tables = [
            'head_approval_tasks' => [
                'soft_deletes' => false,
                'columns' => ['sppg_unit_id', 'source_type', 'source_id', 'module_code', 'module_label', 'document_number', 'document_title', 'document_date', 'source_status', 'task_status', 'submitted_by', 'submitted_by_name_snapshot', 'submitted_at', 'processed_by', 'processed_at', 'notes', 'metadata'],
            ],
            'head_executive_reports' => [
                'soft_deletes' => true,
                'columns' => ['uuid', 'sppg_unit_id', 'report_number', 'period_type', 'date_from', 'date_to', 'generated_at', 'division_summary', 'nutrition_summary', 'approval_summary', 'incident_summary', 'executive_summary', 'decisions', 'follow_up', 'status', 'generated_by', 'finalized_by', 'finalized_at', 'planned_beneficiaries', 'confirmed_beneficiaries', 'actual_beneficiaries', 'planned_portions', 'delivered_portions', 'returned_portions', 'completed_destinations', 'failed_destinations', 'late_destinations', 'containers_sent', 'containers_returned', 'containers_damaged', 'containers_lost', 'pending_approvals', 'approved_documents', 'open_incidents', 'critical_incidents'],
            ],
        ];
    ...
    {
        foreach (['head_executive_reports', 'head_approval_tasks'] as $tableName) {
